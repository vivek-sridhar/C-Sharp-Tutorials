    ...
    switch (input)
    {
        ...
        case "R":
            ...
            else
            {
                ...
                bool isIndexNumber = int.TryParse(choice, out int index);
                if (isIndexNumber)
                {                    
...
void presentTodoList(List<String> todos)
{
    var counter = 0;
...
void errorDisplay(string userInput, string errorCode)
{
    switch (userInput + "-" + errorCode)
    {
        case "A-empty":
